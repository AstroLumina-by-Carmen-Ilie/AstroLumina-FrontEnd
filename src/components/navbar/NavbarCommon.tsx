...
export const getNavbarStyles = () => {
  return {
    ...
    linkClasses:
      "text-cosmic-200 hover:text-white px-4 py-2 rounded-lg text-base font-semibold transition-all duration-200 hover:bg-white/10 cursor-pointer",
    mobileLinkClasses:
      "text-cosmic-200 hover:text-white block px-4 py-3 rounded-lg text-lg font-semibold transition-all duration-200 hover:bg-white/10 cursor-pointer",
    logoClasses:
