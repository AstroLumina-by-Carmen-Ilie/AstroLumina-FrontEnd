...
interface PredictiveBirthDataFormProps {
  onNext: (firstPayload: BirthDataPayload, secondPayload: BirthDataPayload) => void;
}

const PredictiveBirthDataForm: React.FC<PredictiveBirthDataFormProps> = ({ onNext }) => {
...
export default PredictiveBirthDataForm;