      ...
      <div className="overflow-x-hidden relative pt-24 pb-16">
        ...
        <div className="relative z-10 px-6 mx-auto max-w-4xl">
          ...
          <div className="mb-16 text-center">
            {/* Photo placeholder */}
            <div className="flex justify-center items-center mx-auto mb-8 w-40 h-40 bg-gradient-to-br rounded-full border-2 from-cosmic-500/30 to-gold-500/30 border-white/10">
            ...
            <p className="mb-2 text-lg italic font-display text-cosmic-300">
              Astrolog & Consultant Spiritual
            </p>
            <blockquote className="mt-4 text-base italic text-cosmic-200/60">
          ...
          <div className="space-y-8">
            <div className="p-8 glass-card">
              <div className="flex gap-3 items-center mb-4">
                <div className="flex justify-center items-center w-10 h-10 rounded-xl bg-cosmic-500/20 text-cosmic-400">
            ...
            <div className="p-8 glass-card">
              <div className="flex gap-3 items-center mb-4">
                <div className="flex justify-center items-center w-10 h-10 rounded-xl bg-gold-500/20 text-gold-400">
