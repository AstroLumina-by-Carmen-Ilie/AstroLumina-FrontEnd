...
interface PaymentFormPredictiveProps {
...
const CheckoutFormPredictive: React.FC<{
  ...
  const fetchClientSecret = useCallback(() => {
    ...
    return fetch(`${PAYMENT_API_URL}/create-checkout-session/astrograma-previzionala`, {
      method: "POST",
      headers: {
...
const PaymentFormPredictive: React.FC<PaymentFormPredictiveProps> = ({ selectedSlot, onNext, onBack }) => {
      ...
      <div className="bg-white/5 p-4 rounded-xl border border-white/10 mb-6">
        <div className="mb-6 pb-4 border-b border-white/10">
          <p className="text-cosmic-200 text-sm">
            <span className="font-semibold">Plată pentru:</span> Astrograma Previzională
          </p>
...
export default PaymentFormPredictive;
