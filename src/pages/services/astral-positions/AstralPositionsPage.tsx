...
import { AstralHouses, AstralPositions } from '../../../types/astralPositions';
...
const AstralPositionsPage: React.FC = () => {
  const [result, setResult] = useState<{astral_elements: AstralPositions, astral_houses: AstralHouses} | null>(null);
