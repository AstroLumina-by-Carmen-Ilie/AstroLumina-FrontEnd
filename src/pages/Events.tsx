...
const eventDescriptions: Record<
  string,
  { description: string; details: string[] }
> = {
  Martie: {
    description:
      "O seară magică de explorare a energiilor cosmice ale lunii martie. Vom analiza configurațiile astrale curente și impactul lor asupra evoluției noastre spirituale.",
    details: [
  ...
  Aprilie: {
    description:
      "Explorăm energiile de transformare ale lunii aprilie. Un workshop intensiv despre cum să folosim influențele planetare pentru creștere personală și spirituală.",
    details: [
  ...
  Mai: {
    description:
      "Luna mai aduce energii de expansiune și comunicare. Vom explora cum să folosim aceste influențe pentru a ne exprima autentic și a ne conecta cu ceilalți.",
    details: [
  ...
  Iunie: {
    description:
      "Luna iunie aduce energii de expansiune și comunicare. Vom explora cum să folosim aceste influențe pentru a ne exprima autentic și a ne conecta cu ceilalți.",
    details: [
      "Energii de comunicare și expresie",
      "Explorarea relațiilor și conexiunilor",
      "Tehnici de exprimare personală",
  ...
  Octombrie: {
    description:
      "Luna octombrie aduce energii de transformare profundă. Vom explora cum să ne eliberăm de blocaje și să ne îmbrățișăm potențialul.",
    details: [
  ...
  Noiembrie: {
    description:
      "Luna noiembrie ne invită la recunoștință și completare. Vom explora cum să încheiem cicluri și să ne pregătim pentru nou început.",
    details: [
  ...
  Decembrie: {
    description:
      "Luna decembrie aduce energii de revelație și iluminare. Vom explora cum să ne conectăm cu adevărul interior și să ne manifestăm destiny.",
    details: [
